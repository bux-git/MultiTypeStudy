package com.dqr.www.multitypestudy.widget.ijkvideo;
...
public class VideoController extends BaseVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private Animation showAnim = AnimationUtils.loadAnimation(getContext(), com.devlin_n.videoplayer.R.anim.anim_alpha_in);
    private Animation hideAnim = AnimationUtils.loadAnimation(getContext(), com.devlin_n.videoplayer.R.anim.anim_alpha_out);
    ...
    protected void initView() {
        super.initView();
        moreMenu = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.more_menu);
        moreMenu.setOnClickListener(this);
        fullScreenButton = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.fullscreen);
        fullScreenButton.setOnClickListener(this);
        bottomContainer = (LinearLayout) controllerView.findViewById(com.devlin_n.videoplayer.R.id.bottom_container);
        topContainer = (LinearLayout) controllerView.findViewById(com.devlin_n.videoplayer.R.id.top_container);
        videoProgress = (SeekBar) controllerView.findViewById(com.devlin_n.videoplayer.R.id.seekBar);
        videoProgress.setOnSeekBarChangeListener(this);
        totalTime = (TextView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.total_time);
        currTime = (TextView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.curr_time);
        backButton = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.back);
        backButton.setOnClickListener(this);
        lock = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.lock);
        lock.setOnClickListener(this);
        thumb = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.thumb);
        thumb.setOnClickListener(this);
        playButton = (ImageView) controllerView.findViewById(R.id.iv_play);
        playButton.setOnClickListener(this);
        //startPlayButton = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.start_play);
        loadingProgress = (ProgressBar) controllerView.findViewById(com.devlin_n.videoplayer.R.id.loading);
        bottomProgress = (ProgressBar) controllerView.findViewById(com.devlin_n.videoplayer.R.id.bottom_progress);
        ImageView rePlayButton = (ImageView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.iv_replay);
        rePlayButton.setOnClickListener(this);
        completeContainer = (LinearLayout) controllerView.findViewById(com.devlin_n.videoplayer.R.id.complete_container);
        completeContainer.setOnClickListener(this);
        title = (TextView) controllerView.findViewById(com.devlin_n.videoplayer.R.id.title);
        statusHolder = controllerView.findViewById(com.devlin_n.videoplayer.R.id.status_holder);
        ...
        popupMenu.getMenuInflater().inflate(com.devlin_n.videoplayer.R.menu.controller_menu, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                int itemId = item.getItemId();
                if (itemId == com.devlin_n.videoplayer.R.id.float_window) {
                    mediaPlayer.startFloatWindow();
                } else if (itemId == com.devlin_n.videoplayer.R.id.scale_default) {
                    mediaPlayer.setScreenScale(IjkVideoView.SCREEN_SCALE_DEFAULT);
                } else if (itemId == com.devlin_n.videoplayer.R.id.scale_original) {
                    mediaPlayer.setScreenScale(IjkVideoView.SCREEN_SCALE_ORIGINAL);
                } else if (itemId == com.devlin_n.videoplayer.R.id.scale_match) {
                    mediaPlayer.setScreenScale(IjkVideoView.SCREEN_SCALE_MATCH_PARENT);
                } else if (itemId == com.devlin_n.videoplayer.R.id.scale_16_9) {
                    mediaPlayer.setScreenScale(IjkVideoView.SCREEN_SCALE_16_9);
                } else if (itemId == com.devlin_n.videoplayer.R.id.scale_4_3) {
    ...
    public void setPlayerState(int playerState) {
        switch (playerState) {
            case IjkVideoView.PLAYER_NORMAL:
                ...
                WindowUtil.scanForActivity(getContext()).getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        ...
        switch (playState) {
            ...
            case IjkVideoView.STATE_PLAYING:
                ...
                if(playButton.getVisibility()==VISIBLE){
                    ...
                    playButton.startAnimation(hideAnim);
                }
                break;
    ...
    private void doLockUnlock() {
        if (isLocked) {
            ...
            show();
            lock.setSelected(false);
            Toast.makeText(getContext(), com.devlin_n.videoplayer.R.string.unlocked, Toast.LENGTH_SHORT).show();
        } else {
            hide();
            isLocked = true;
            gestureEnabled = false;
            lock.setSelected(true);
            Toast.makeText(getContext(), com.devlin_n.videoplayer.R.string.locked, Toast.LENGTH_SHORT).show();
        }
    ...
    public void setMoreMenuVisibility(boolean visibility){
        moreMenu.setVisibility(visibility?VISIBLE:GONE);
    }
    ...
    private void showAllViews() {
        ...
        if(playButton.getVisibility()==GONE) {
            playButton.setVisibility(VISIBLE);
            playButton.startAnimation(showAnim);
        }
        // WindowUtil.showStatusBar(getContext());
        // WindowUtil.showNavKey(getContext());
    }
